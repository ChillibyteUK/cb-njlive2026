(function(){
  function start(){
    ...
    var PALETTE_RATIOS = {
      'mint-blue': { a: 1.5, b: 1.2, c: 0.7, w: 0.50 },
      'violet':    { a: 1.6, b: 1.3, c: 0.8, w: 0.45 },
      'warm':      { a: 1.20, b: 1.00, c: 0.95, w: 0.55 }
    };
    ...
    function applyPalette(){
      ...
      console.log('Palette mode:', mode);
      console.log('Parsed colors:', cols);
      console.log('Ratios:', r);
      ...
      console.log('uniforms set:', uniforms.uColA.value, uniforms.uColB.value, uniforms.uColC.value, uniforms.uColD.value);
    }
    applyPalette();
    ...
    var material = new THREE.ShaderMaterial({
      ...
      fragmentShader: [
        ...
        ' vec3 col = uColD*uRatioW + uColA*m1*uRatioA + uColB*m2*uRatioB + uColC*m3*uRatioC; col /= (uRatioW + m1*uRatioA*0.6 + m2*uRatioB*0.6 + m3*uRatioC*0.6);',
