...
function acf_blocks() {
    if ( function_exists( 'acf_register_block_type' ) ) {
        ...
        acf_register_block_type(
            array(
                'name'            => 'cb_single_case_study_feature',
                'title'           => __( 'CB Single Case Study Feature' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-single-case-study-feature.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'cb_full_video_hosted',
                'title'           => __( 'CB Full Video (Hosted)' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-full-video-hosted.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                ...
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-contact-hero.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'cb_solution',
                'title'           => __( 'CB Solution' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-solution.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
